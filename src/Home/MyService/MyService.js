        ...
        overflowX: 'hidden' }} className="py-5">
            ...
            <div>
                <div data-aos="zoom-in" className="mb-5">
                    <Card className="mx-auto text-center card" style={{ width: '22rem', height: 'fit the content', padding: '10px' }}>
                        <Card.Body>
                ...
                <div className="row px-3">
                    <div data-aos="zoom-in-right" className="col-md-4 mb-5">
                        <Card className="mx-auto text-center card" style={{ width: '80%', height: 'fit the content', padding: '10px' }}>
                            <Card.Body>
                    ...
                    <div data-aos="zoom-in-left" className="col-md-4 mb-5">
                        <Card className="mx-auto text-center card" style={{ width: '80%', height: 'fit the content', padding: '10px' }}>
                            <Card.Body>
                                ...
                                <Card.Title className="mx-auto text-center" style={{ borderBottom: '3px solid goldenrod', width: '100px' }}></Card.Title>
                                <Card.Text>
                                    I can do fully responsive website.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </div>
